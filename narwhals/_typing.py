...
_DataFusion: TypeAlias = Literal["datafusion"]
...
_DataFusionImpl: TypeAlias = Literal[Implementation.DATAFUSION]
...
DataFusion: TypeAlias = Literal[_DataFusion, _DataFusionImpl]
...
LazyOnly: TypeAlias = Literal[SparkLike, Dask, DataFusion, DuckDB, Ibis]
